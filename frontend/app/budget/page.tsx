    ...
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between glass-panel p-4 rounded-xl">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-base font-bold text-white">Monthly Target Rules</h3>
      ...
      <Card className="p-8 relative overflow-hidden">
        {loading ? (
          <div className="h-36 rounded-lg bg-slate-800/40 animate-pulse" />
        ) : !overall ? (
          <div className="text-center py-8 space-y-3">
            <Wallet className="w-10 h-10 mx-auto text-slate-500 opacity-50" />
            <h3 className="text-lg font-bold text-slate-200">No Overall Budget Goal Set</h3>
          ...
          <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <span className="text-xs font-semibold uppercase tracking-wider text-slate-400">Overall Target</span>
      ...
      <div>
        <h3 className="text-xl font-bold text-white mb-4">Category Budgets</h3>
        {categoryBudgets.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {categoryBudgets.map((item, idx) => (
              <Card key={item.budget_id || idx} className="space-y-4">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  <CardTitle className="text-base">{item.category_name}</CardTitle>
                  <span
                ...
                <CardContent className="space-y-3">
                  ...
                  <p className="text-[11px] text-right text-slate-400 font-mono">
